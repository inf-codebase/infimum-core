...
from infimum.database.interfaces import RelationalDatabaseManager, DocumentDatabaseManager
...
class DatabaseFactory:
    ...
    def __init__(self):
        ...
        from infimum.database.plugins import register_builtin_backends, discover_database_plugins
    ...
    def _create_manager_legacy(self, db_type: str, config_dict: Dict, async_mode: bool) -> DatabaseManager:
        ...
        if db_type == self.DatabaseType.POSTGRES:
            ...
            from infimum.database.milvus import MilvusManager
