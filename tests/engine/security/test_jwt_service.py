...
class TestJWTService:
    ...
    def jwt_service(self):
        ...
        from core.engine.security.jwt_service import JWTService
        from core.engine.security.token_blacklist import TokenBlacklistService
...
class TestJWTServiceSingleton:
    ...
    def test_get_jwt_service_singleton(self):
        ...
        from core.engine.security.jwt_service import get_jwt_service, reset_jwt_service
