...
class ProviderRegistry:
    ...
    @classmethod
    def search(cls, model_type: Optional[str] = None, capabilities: Optional[List[str]] = None) -> List[str]:
        """
    ...
    def get_by_type(cls, model_type: str) -> List[ProviderMetadata]:
        ...
        """
        return [meta for meta in cls._providers.values() if meta.model_type == model_type]
