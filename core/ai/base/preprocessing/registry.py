...
class TransformRegistry:
    ...
    def register(cls, transform_id: str, metadata: TransformMetadata) -> None:
        ...
        .. deprecated::
            Use :func:`register_transform` from ``core.ai.base.preprocessing.registration``
        ...
        """
        warnings.warn(
            "TransformRegistry.register() is deprecated. "
            "Use register_transform() from core.ai.base.preprocessing.registration instead, "
    ...
    def search(cls, data_type: Optional[str] = None) -> List[str]:
        ...
        if data_type is None:
            return cls.list_all()
        return [
            tid for tid, meta in cls._transforms.items() if meta.data_type == data_type
        ]
    ...
    def get_by_type(cls, data_type: str) -> List[TransformMetadata]:
        ...
        """
        return [
            meta for meta in cls._transforms.values() if meta.data_type == data_type
        ]
