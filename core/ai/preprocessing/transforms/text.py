...
class TokenizeTransform(BaseTransform):
    ...
    def transform(self, data: DataItem) -> DataItem:
        ...
        if data.data_type != "text":
            raise ValueError(f"TokenizeTransform expects text data, got {data.data_type}")
...
class NormalizeTextTransform(BaseTransform):
    ...
    def transform(self, data: DataItem) -> DataItem:
        ...
        """
        if data.data_type != "text":
            raise ValueError(f"NormalizeTextTransform expects text data, got {data.data_type}")
