...
class ModelManagerProviderAdapter(BaseProvider):
    ...
    def load_model(self, config: ModelConfig) -> ModelHandle:
        ...
        try:
            from ...vlm.models.model_manager import ModelManager, ModelConfig as VLMConfig
        except ImportError:
            # Fallback to existing location
            from ...visual_language_model.model_manager import ModelManager, ModelConfig as VLMConfig
