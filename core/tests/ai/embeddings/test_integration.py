...
class TestClassHierarchy:
    ...
    def test_embedding_provider_extends_base_provider(self):
        from core.ai.base.providers.base import BaseProvider
    ...
    def test_openai_provider_extends_embedding_provider(self):
        from core.ai.embeddings.base import EmbeddingProvider
        from core.ai.embeddings.providers.openai import OpenAIEmbeddingProvider
    ...
    def test_model_type_enum_has_embedding(self):
        from core.ai.base.providers.config import ModelType
...
class TestProviderFactory:
    ...
    def test_openai_is_registered(self):
        ...
        import core.ai.embeddings.providers.openai  # noqa: F401
...
class TestProviderRegistry:
    def test_openai_registered_in_registry(self):
        from core.ai.base.providers.registry import ProviderRegistry
...
class TestObserverEvents:
    ...
    def test_embed_fires_inference_events(self, mock_openai_cls):
        ...
        from core.ai.base.observers.events import EventType
        from core.ai.embeddings.providers.openai import OpenAIEmbeddingProvider
...
class TestBackwardCompatibility:
    ...
    def test_old_base_import_still_works_with_warning(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            import core.ai.preprocessing.embeddings.base  # noqa: F401
    ...
    def test_old_openai_import_still_works_with_warning(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            warnings.simplefilter("always")
            import core.ai.preprocessing.embeddings.openai_provider  # noqa: F401
